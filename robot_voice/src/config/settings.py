...
class Settings:
    ...
    ai_enabled: bool = field(default_factory=lambda: os.getenv("AI_ENABLED", "1") != "0")
    ai_model_type: str = field(default_factory=lambda: os.getenv("AI_MODEL_TYPE", "tasx"))
    ai_model_path: str = field(default_factory=lambda: os.getenv("AI_MODEL_PATH", "models/tasx-cmd-0.5b-q4_k_m.gguf"))
